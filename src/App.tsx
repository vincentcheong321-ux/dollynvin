    ...
    return (
      <div className="min-h-screen flex flex-col sakura-bg animate-fadeIn">
        <header className="bg-transparent p-4">
           <div className="max-w-3xl mx-auto flex items-center justify-between"><div className="w-10"></div><div className="w-10"></div><div className="flex items-center gap-2"><button onClick={() => setIsChatOpen(true)} className="p-2 text-rose-600 hover:bg-rose-50 rounded-full transition-colors"><SparklesIcon className="w-5 h-5" /></button><button onClick={() => setIsNotesOpen(!isNotesOpen)} className="p-2 text-rose-400 hover:bg-rose-50 rounded-full transition-colors"><NoteIcon className="w-5 h-5" /></button></div></div>
        </header>
